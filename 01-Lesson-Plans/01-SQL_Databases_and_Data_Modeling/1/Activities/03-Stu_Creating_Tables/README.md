...
In this activity, you will use pgAdmin to query a table and retrieve the results provided.
...
3. Insert data into the new table. The result should match the following table.
...
4. Query the table to display the data below.
